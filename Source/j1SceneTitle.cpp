...
void j1SceneTitle::ui_callback(UiElement* element) {
	...
	if (element == optionsButton) {
		...
		if (optionsMenu == nullptr) {
			optionsMenu = App->gui->AddButton(/*40*/0, 200, { 20,540,446,465 }, { 20,540,446,465 }, { 20,540,446,465 }, true, false, nullptr, this);
			App->gui->AddText(360, 250, "OPTIONS MENU", nullptr, { 0,255,0,255 }, 42, false, false, optionsMenu);
			backButton = App->gui->AddButton(0, 220, { 806,368,35,24 }, { 815,246,35,24 }, { 806,368,35,24 }, true, false, optionsMenu, this);
		}
	}
	if (element == backButton) {
			App->gui->RemoveUiElement(playButton);
	}
