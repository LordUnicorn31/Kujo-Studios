...
void Building::UiFunctionallity() {
	switch (Btype) {
	case BuildingType::Cuartel:
		App->gui->AddText(18, 240, "Barracks", App->font->Default, { 236,178,0,255 }, 32, false, false, App->entity->Panel);
		...
		break;
	case BuildingType::Base:
		App->gui->AddText(56, 240, "Base", App->font->Default, { 236,178,0,255 }, 32, false, false, App->entity->Panel);
		...
		break;
	case BuildingType::Mine:
		App->gui->AddText(56, 240, "Mine", App->font->Default, { 236,178,0,255 }, 32,false,false,App->entity->Panel);
		break;
	case BuildingType::Spaceship_factory:
		App->gui->AddText(66, 240, "Lab", App->font->Default, { 236,178,0,255 }, 32, false, false, App->entity->Panel);
		break;
	case BuildingType::PowerGenerator:
		App->gui->AddText(16, 240, "Generator", App->font->Default, { 236,178,0,255 }, 32, false, false, App->entity->Panel);
		break;
	}
}
