...
bool GameScene::Start()
{
	...
	pauseButton = App->gui->AddButton(1200, 10, { 755, 527, 39,39 }, { 871, 736, 39,39 }, { 755, 527, 39,39 }, true, false, nullptr, this);
	infoImage = App->gui->AddImage(750, 10, { 494,640,332,52 }, true, false, nullptr, this);
	peopleImage = App->gui->AddImage(30, 5, { 591,494,40,37 }, false, false, infoImage, nullptr);
	copperImage = App->gui->AddImage(130, 12, { 679,501,28,29 }, false, false, infoImage, nullptr);
	titaniumImage = App->gui->AddImage(230, 12, { 641,498,30,31 }, false, false, infoImage, nullptr);
	App->minimap->Enable();
	App->entity->Enable();
...
void GameScene::ui_callback(UiElement* element) {
	...
	if (element == optionsButton) {
		...
		App->gui->AddText(150, 20, "OPTIONS MENU", App->font->smallFont, { 236,178,0 }, 42, false, false, optionsMenu);
		App->gui->AddText(70, 100, "FX", App->font->smallFont, { 236,178,0 }, 42, false, false, optionsMenu);
		App->gui->AddText(50, 200, "MUSIC", App->font->smallFont, { 236,178,0 }, 42, false, false, optionsMenu);
	}
