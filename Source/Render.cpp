...
// Blit to screen
bool Render::Blit(SDL_Texture* texture, int x, int y, const SDL_Rect* section, bool use_camera, SDL_Renderer* renderer, float scale, float speed, double angle, int pivot_x, int pivot_y) const
{
	bool ret = true;
